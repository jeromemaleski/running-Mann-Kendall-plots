...
%
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%modified by jerome maleski 5/4/2015 to remove some functionality and tests
%in order to streamline runing a large number of MK tests
%
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%
% Important Note: 
...
function [h, sig, sen] = ktaubSen_JM(datain, alpha)
